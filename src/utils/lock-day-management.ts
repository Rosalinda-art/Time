...
export const validateDayLock = (
  ...
  // Check 1: Critical deadline sessions - Warn about important sessions near deadline
  ...
  if (criticalSessions.length > 0) {
    warnings.push(`Day contains ${criticalSessions.length} important session(s) within 2 days of deadline`);
  }
